...
# Generate Docker Compose, README, and Viva Defense documents
...
# README.md
readme = """# NormalDB: Interactive Database Normalization Platform
...
print("✅ Docker Compose and README generated!")
